...
3. Quickly pipette cryopreserved cells, now completely thawed, into 15 mL centrifuge tube(s).

4. Quickly pipette **1 mL** of fresh pre-warmed growth media drop-by-drop into the centrifuge tube(s).

5. Centrifuge the resuspended cells at **24°C and 130 rcf for five minutes** to form a cell pellet.

6. While the centrifuge is spinning, pipette **4 mL** of fresh pre-warmed growth media into T25 cell culture flask(s).
...
8. Resuspend the cell pellet with **1 mL** of fresh pre-warmed growth media, and dispense into the cell culture flask(s).
