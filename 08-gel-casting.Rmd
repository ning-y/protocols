...
1. Gently wash and dry the gel casting mold with tap water, then 70% ethanol.

2. Assemble the gel casting mold as in Figure \@ref(fig:biorad-10007296-rev-d-figure-3).
    1. Place the casting frame on a flat surface
    2. Insert the glass slide and spacer, with spacer facing away from the locking mechanisms, such that the bottom edges of the glass slides and spacer are in level contact with the flat surface which the casting frame is sitting upon (Figure \@ref(fig:biorad-10007296-rev-d-figure-3).3b)
...
12. The whole assembled casting frame can be used immediately for electrophoresis, or kept in a 4°C fridge for about a week.
