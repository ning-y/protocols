...
5. Add **(1 mL if T25 / 2 mL if T75)** of trypsin and incubate for up to five minutes.
    
6. While the cells are incubating, pipette **(4 mL if T25 / 10 mL if T75)** of fresh media into new cell culture flask(s).
...
8. Add **(1 mL if T25 / 2 mL if T75)** of fresh medium containing fetal bovine serum (FBS) into the cell culture flask(s).
   Mix and rinse the base of the cell culture flask by pipetting.

9. Transfer the cell suspension into a 15 mL centrifuge tube.

10. Centrifuge the suspended cells at **24°C and 130 rcf for five minutes** to form a cell pellet.

11. Once the centrifuge is done, dispose of the supernatant by aspirating with a pipette.

12. Resuspend the cell pellet with **1 mL – 2 mL** of fresh pre-warmed growth media, and dispense into the new cell culture flask(s).
