...
7. Add fresh medium containing fetal bovine serum (FBS) into the cell culture flask(s) or well(s) containing the trypsinized cell suspension.
   If cells in the cell suspension(s) are not dissociated into single cells, gently pipette the cell suspension(s) for about 10 times to encourage dissociation. 
