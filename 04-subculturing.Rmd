...
6. While the cells are incubating, pipette **(4ml if T25 / 10ml if T75)** of fresh media into new cell culture flask(s).
...
9. Transfer the cell suspension into a 15ml centrifuge tube.

10. Centrifuge the suspended cells at **24°C and 130rcf for five minutes** to form a cell pellet.

11. Once the centrifuge is done, dispose of the supernatant by aspirating with a pipette.

12. Resuspend the cell pellet with **1ml – 2ml** of fresh pre-warmed growth media, and dispense into the new cell culture flask(s).
    - Adjust the amount of fresh pre-warmed growth media to add, the number and size of new cell culture flasks, and amount of resuspended cells to dispense into each flask; to target a final confluency of about 20%

13. Inspect the flask(s) under a microscope.

14. Gently mix the culture flask(s) and place into the incubator.
