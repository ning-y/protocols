...
7. Add **(1 mL if T25 / 2 mL if T75)** of fresh medium containing fetal bovine serum (FBS) into the cell culture flask(s).
   Mix and rinse the base of the cell culture flask by pipetting.

8. Transfer the cell suspension into a 15 mL centrifuge tube.

9. Centrifuge the suspended cells at **24°C and 130 rcf for five minutes** to form a cell pellet.
...
11. Resuspend the cell pellet with pre-warmed freezing media.
    - Adjust the amount of pre-warmed freezing media to add so that each cryotube containing 1 mL of resuspended cells can seed a T25 flask with appropriate confluency

12. Dispense 1 mL of resuspended cells into each pre-labelled cryotube
